...
public class RequeteSelectFactureLogementImmeuble implements Requete<Locataire> {

	@Override
	public String requete() {
		return "SELECT f.* FROM SAE_FACTURE f, SAE_LOGEMENT l WHERE f.numero = l.numero_l AND l.id_immeuble = ? AND f.Immeuble = 0";
	}
